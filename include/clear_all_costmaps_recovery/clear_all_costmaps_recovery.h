...
public:
    ...
    /**
      ...
      */
    void initialize(std::string name, tf2_ros::Buffer* tf, costmap_2d::Costmap2DROS* global_costmap, costmap_2d::Costmap2DROS* local_costmap) override;//don't use c++11
...
private:
    ros::NodeHandle nh;
    ros::ServiceClient clear_costmap{nh.serviceClient<std_srvs::Empty>("/move_base/clear_costmaps")};//clear costmap client
};
}//end namespace
